    ...
    return (
        <div className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center p-6">
                ...
                >
                    Digitale Lösungen,<br />die wirklich <span className="text-purple-400">wirken.</span>
                </motion.h1>
                ...
                >
                    Wir gestalten Marken, bauen leistungsstarke Websites und automatisieren Ihre Büroprozesse – damit Sie sich auf das Wesentliche konzentrieren können.
                </motion.p>
                ...
                >
                    ...
                    <button className="px-8 py-4 bg-transparent border border-white/20 text-white font-semibold rounded-lg hover:bg-white/10 transition-colors duration-300">
                        Kontakt aufnehmen
                    </button>
                </motion.div>
            </div>
